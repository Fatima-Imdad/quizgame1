...
<body style =" background-color:linear-gradient(to bottom, #000000 0%, #4d4d4d 100%);">
    <nav class="navbar navbar-default title1">
        ...
        <!-- <div id = "timer">
				<p><i id = timerIcon class="far fa-clock"></i></p>
				<span id = "totalTimer"><span id = "timerMinute">00</span>:<span id = "timerSecond">00</span></span>
			</div>    -->
                ...
                <?php
                    ...
                    if(@$_GET['q']== 'result' && @$_GET['eid']) 
                    {
                        ...
                        while($row=mysqli_fetch_array($q) )
                        {
                            ...
                            if($w>0)
                            {
                                echo '<div style="margin-top:700px;">';
                                include 'puzzle.php';
                            
                                if($_SESSION["winner"]=="win")
                                {
