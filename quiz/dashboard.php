...
<head>
    ...
    body{
        width: 100%;
                  background: url(image/QUUUU.png) ;
...
<body>
    <nav class="navbar navbar-default title1">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="Javascript:void(0)"><b> Quiz Game</b></a>
            </div>
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <button type="button" style="margin:10px" class="btn btn-success"><a href="insert.php">insert</a></button>  
            </div>
  ...
  <div class="container" style="display:incline-block">
     <div class="row product_style_3"> 
      <!-- product -->
       <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
        <div class="full product">
          <div class="product_img">
            <div class="center"> <img src="image/pp.png" alt="#"/>
              <div class="overlay_hover"><button type="button" class="btn btn-danger"> <a class="add-bt" href="puzzle.php">playgame</a></button> </div>
            </div>
          </div>
      ...
      <div class="ourproduct">
  <div class="container" style="display:incline-block;padding:200px;margin:300px">
     <div class="row product_style_3"> 
      <!-- product -->
       <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
        <div class="full product">
          <div class="product_img">
            <div class="center"> <img src="image/pp1.png" alt="#"/>
              <div class="overlay_hover"><button type="button" class="btn btn-danger"> <a class="add-bt" href="puzzle1.php">playgame</a></button> </div>
            </div>
          </div>
